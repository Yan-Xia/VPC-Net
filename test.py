...
if __name__ == '__main__':
    ...
    parser.add_argument('--list_path', default='data/shapenet_car/test_car.list')
    parser.add_argument('--data_dir', default='data/shapenet_car/test')
    parser.add_argument('--model_type', default='vpc')
    parser.add_argument('--checkpoint', default='log/vpc/model-100000')
    parser.add_argument('--results_dir', default='results/vpc')
