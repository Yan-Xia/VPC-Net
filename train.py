...
from visu_util import plot_pcd_three_views, plot_pcd_four_views
...
def train(args):
    ...
    model = model_module.Model(inputs_pl, npts_pl, gt_pl, alpha, args.is_training)
    ...
    if args.restore:
        ...
        os.system('cp train_STN_PFL_refinenet_fps.py %s' % args.log_dir)                         # bkp of train procedure
        ...
        if step % args.steps_per_eval == 0:
            ...
            if step % args.steps_per_visu == 0:
                ...
                for i in range(0, args.batch_size, args.visu_freq):
                    ...
                    plot_pcd_four_views(plot_path, pcds, model.visualize_titles)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', default='log/vpc')
    parser.add_argument('--model_type', default='vpc')
